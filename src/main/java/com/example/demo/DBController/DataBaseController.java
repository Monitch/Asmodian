...
public class DataBaseController {
    ...
    public String getCountOfPatientOfCurrentUser(String doctor){
        String count = "";
        try {
            PreparedStatement preparedStatement =
                    connection.prepareStatement(
                            "select count(*) as count from disease where  doctor = ?");
    ...
    public String getCountOfSick(String doctor){
        String count = "";
        try {
            PreparedStatement preparedStatement =
                    connection.prepareStatement(
                            "select count(*) as count from disease where disease.disease<>'Здоровий' and doctor = ?");
            preparedStatement.setString(1, doctor);
            ResultSet resultSet = preparedStatement.executeQuery();
            while (resultSet.next()) {
                count = resultSet.getString("count");
    ...
    public String getCountOfHealthy(String doctor){
        String count = "";
        try {
            PreparedStatement preparedStatement =
                    connection.prepareStatement(
    ...
    public String getMostPopularIll(String doctor){
        String count = "";
        try {
            PreparedStatement preparedStatement =
                    connection.prepareStatement(
                            "select disease.disease as dis, count(*) as count  from disease where doctor=? group by dis limit 1");
            preparedStatement.setString(1, doctor);
            ResultSet resultSet = preparedStatement.executeQuery();
            while (resultSet.next()) {
                count = resultSet.getString("dis");
            }
            return count;
        } catch (SQLException throwables) {
            throwables.printStackTrace();
    ...
    public String getMostPopularIllCount(String doctor){
        String count = "";
        try {
            PreparedStatement preparedStatement =
                    connection.prepareStatement(
    ...
    public String getCountOfSickOfCOVid(String doctor){
        String count = "";
        try {
            PreparedStatement preparedStatement =
                    connection.prepareStatement(
                            "select  count(*) as count from disease\n" +
                                    "where disease.disease='COVid 19' and doctor=?");
            preparedStatement.setString(1, doctor);
            ResultSet resultSet = preparedStatement.executeQuery();
            while (resultSet.next()) {
                count = resultSet.getString("count");
